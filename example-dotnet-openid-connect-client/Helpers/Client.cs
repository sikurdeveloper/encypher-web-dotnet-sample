...
namespace exampledotnetopenidconnectclient.Helpers
{
    public class Client
    {
        ...
        private Client()
        {
            ...
            return_url = _config.GetReturnUri();
            response_type = _config.GetResponseType();
        }
        ...
        public String GetAuthnReqUrl()
        {
            return authorization_endpoint +
                           ...
                           "&client_id=" + client_id +
                           "&state=4Xa6T31XAAB78zkIeA8UafZozdSo47HYzNgB5HS6;openIdConnect=1" +
                           "&redirect_uri=" + redirect_uri +
                           "&scope=" + scope +
                           "&profile%2520email" +
                           "&nonce=4Xa6T31XAAB78zkIeA8UafZozdSo47HYzNgB5HS6";
        }
